...
def prepare_dataset(data_directory, img_height, img_width, batch_size):
    ...
    train_folder = 'resized_train' # os.path.join('train', 'train')  # Change this path
    validation_folder = 'resized_validation' # os.path.join('validation', 'validation')  # Change this path
